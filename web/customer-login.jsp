...
<html>
    <head>
     ...
     <body style="background-image: url('./back_g1.jpg'); background-size: cover; background-position: center; font-family: 'Times New Roman', Times, serif; color: pink;">
            ...
            <div class="modal-content modal-info">
                ...
                <div class="modal-body modal-spa">
                    <div class="login-grids" >
                        <div class="login">
                            <div class="login-right" >
                                ...
                                <form action="CustomerLogin" method="post">
                                    ...
                                    <div class="sign-in">
                                        <input type="submit" value="SIGN IN" style="width: 680px; background-color: black;">
                                    </div>
                                </form>
                            </div>
                            <div class="clearfix"></div>
                        ...
                        <p>
                            <a href="customer-register.jsp" style=" font-family: 'Times New Roman', Times, serif; color: pink; text-align: center;">New to ElegntShine? Create an account</a>
                        </p>
                    </div>
                </div>
            </div>
