...
<html>
    <head>
      ...
      <body style="background-image: url('./back.jpg'); font-family: 'Times New Roman', Times, serif; color: pink;">

        <section class="menu-section" style= font-family: 'Times New Roman', Times, serif; color: pink>
            <div class="container" >
                <div class="row">
                    <div class="col-md-12">
