...
<html>
    ...
    <body>
        ...
        %>
   <body style="background-image: url('./logo2.jpg'); background-size: cover; background-position: center; font-family: 'Times New Roman', Times, serif; color: pink;">
        <div class="ban-top" >
            <div class="container">
                <div class="top_nav_left">
                    ...
                    <div class="top_nav_right">
                        ...
                        <p>
                            <a href="javascript:;" class="simpleCart_empty"  style="background-color: pink;">My Cart</a>
                        </p>
                    </div>
                </div>
            </div>
